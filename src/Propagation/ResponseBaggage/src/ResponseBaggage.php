...
final class ResponseBaggage implements BaggageInterface
{
    ...
    {
        return new ResponseBaggageBuilder();
    }
    ...
    {
        return $context->get(ResponseBaggageContextKeys::responsebaggage()) ?? self::getEmpty();
    }
    ...
    {
        return new ResponseBaggageBuilder($this->entries);
    }

    public function storeInContext(ContextInterface $context): ContextInterface
    {
        return $context->with(ResponseBaggageContextKeys::responsebaggage(), $this);
    }
}
